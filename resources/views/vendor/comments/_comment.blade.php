...
@endif
    {{-- <img class="mr-3" src="{{ Auth::user()->image }}" alt="{{ $comment->commenter->name ?? $comment->guest_name }}"> --}}
    
    <div class="media-body">
        <img class="mr-3" id="zoom" src="{{Auth::user()->image}}" alt="{{ $comment->commenter->name ?? $comment->guest_name }}" srcset=""
